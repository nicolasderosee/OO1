...
import dominio.PoliticaDeCancelacion;
...
public class servicioDePropiedades {
	...
	public Propiedad registrarPropiedad(String nombre, String descripcion, double precioPorNoche, String direccion, Usuario propietario, PoliticaDeCancelacion politica) {
		Propiedad propiedad = new Propiedad (nombre,descripcion,precioPorNoche,direccion,propietario,politica);
