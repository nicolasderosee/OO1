...
public class Propiedad {
	...
	public Propiedad(String nombre, String descripcion, double precioPorNoche, String direccion, Usuario propietario, PoliticaDeCancelacion politica) {
		this.nombre = nombre;
	...
	public void eliminarReserva (Reserva reserva) { 
		if(reserva.evaluarFechaPosterior()) {
	...
	public double cancelarReserva (Reserva reserva, LocalDate fecha) {
		if(this.reservas.contains(reserva)) {
			this.politica.getMontoAReembolsar(reserva,fecha,this.getPrecioPorNoche());
		}
		return 0d;
	}
