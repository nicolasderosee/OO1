...
public class Reserva {
	...
	public boolean evaluarFechaPosterior() {
		return this.periodoOcupado.esPosterior();
	}
	
	public boolean evaluarFechaAnterior(LocalDate fecha) {
		return this.periodoOcupado.esAnterior(fecha);
		
	}
	
	public boolean evaluarFecha(LocalDate fecha, int num) {
		return this.periodoOcupado.diasAntes(fecha, num);
	}
